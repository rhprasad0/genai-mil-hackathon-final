...
| Boundary demo | [`../assets/demo/chatgpt-boundary-demo-v1010.png`](../assets/demo/chatgpt-boundary-demo-v1010.png) | Combined proof that the tool catalog excludes approve/deny/certify/pay powers and that AO Radar refuses fraud/authorization determinations while drafting neutral clarification language. |
